              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="w-[80px]">
                    {t("contracts.classifications.level")}
                  </TableHead>
                  <TableHead className="w-[80px]">
                    {t("contracts.classifications.color")}
                  </TableHead>
                  <TableHead>{t("contracts.classifications.description")}</TableHead>
                      ...
                      <div className="flex flex-col items-center justify-center gap-3 text-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            点击「{t("contracts.classifications.addType")}
                            」按钮添加第一个密级
                          </p>
                        </div>
